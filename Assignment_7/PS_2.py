...
df = pd.read_csv("PS_2.csv")  # replace with your CSV file path
...
plt.legend()
plt.tight_layout()
plt.savefig("Execution_Time_vs_Processes_PS_2.png")
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig("Speedup_vs_Processes_PS_2.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("Execution_Time_vs_MatrixSize_PS_2.png")
plt.show()
